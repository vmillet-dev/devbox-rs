...
/**
 * Import, export and share. The file is written and read back **on the Rust
 * side**: the front only picks a path, otherwise there would be a second
 * serialisation format to keep in TypeScript.
 */
...
export class TransferRepository {
  ...
  /** The same file, restricted to the named notes. */
  ...
  /** Markdown rendering, which the caller puts on the clipboard. */
